...
class DashboardFrame(ctk.CTkFrame):
    ...
    def create_widgets(self):
        ...
        # Configurer les poids pour que tout s'affiche correctement
        self.scrollable_frame.grid_rowconfigure(3, weight=1)  # Les tableaux prennent l'espace
    ...
    def create_stats_section(self, stats):
        ...
        # Configurer stats_frame pour utiliser grid
