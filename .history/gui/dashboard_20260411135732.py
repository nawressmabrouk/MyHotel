...
class DashboardFrame(ctk.CTkFrame):
    ...
    def create_stat_cards(self, stats):
        ...
        cards_config = [
            {"title": "🏨 Chambres", "value": stats['total_chambres'], "subtitle": "Total chambres", "color": "#1a1a2e"},
            {"title": "🟢 Libres", "value": stats['chambres_libres'], "subtitle": "Disponibles", "color": "#1a1a2e"},
            {"title": "🔴 Occupées", "value": stats['chambres_occupees'], "subtitle": f"Taux: {stats['taux_occupation']}%", "color": "#1a1a2e"},
            {"title": "🧹 Nettoyage", "value": stats['chambres_nettoyage'], "subtitle": "En cours", "color": "#1a1a2e"},
            {"title": "👥 Clients", "value": stats['total_clients'], "subtitle": "Inscrits", "color": "#1a1a2e"},
            {"title": "📅 Réservations", "value": f"{stats['reservations_actives']}/{stats['reservations_total']}", "subtitle": "Actives/Total", "color": "#1a1a2e"},
            {"title": "💰 CA Total", "value": f"{stats['ca_total']:,.0f} €", "subtitle": "Chiffre d'affaires", "color": "#1a1a2e"},
            {"title": "📆 CA du mois", "value": f"{stats['ca_mois']:,.0f} €", "subtitle": "Ce mois", "color": "#1a1a2e"},
        ]
    ...
    def create_stats_section(self, stats):
        ...
        if occupation_par_type:
            for ch_type, statuts in occupation_par_type.items():
                ...
                ctk.CTkLabel(
                    type_frame,
                    text=f" Libres {libre}  occupee  {occupee}  nettoyage {nettoyage}  (Total: {total})",
                    font=("Arial", 12)
