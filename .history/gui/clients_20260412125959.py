...
class ClientsFrame(ctk.CTkFrame):
    ...
    def create_widgets(self):
        ...
        style.configure("Treeview.Heading", font=("Arial", 12, "bold"),background="#e67e22",      
                foreground="white",       
                fieldbackground="#e67e22")
        style.map("Treeview",
                  background=[("selected", "#e67e22")],    # ← Couleur de sélection
                  foreground=[("selected", "white")])      # ← Texte de sélection
        ...
        column_configs = {
            ...
            "nom": {"text": "Nom", "width": 250, "anchor": "w"},
            "email": {"text": "Email", "width": 300, "anchor": "w"},
            "telephone": {"text": "Téléphone", "width": 150, "anchor": "center"},
            "adresse": {"text": "Adresse", "width": 300, "anchor": "w"}
        }
