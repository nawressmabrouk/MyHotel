...
class DashboardFrame(ctk.CTkFrame):
    def __init__(self, parent):
        ...
        # Configurer le frame pour utiliser grid
        self.grid_rowconfigure(0, weight=1)  # Pour le contenu principal
    ...
    def create_widgets(self):
        # Frame principal qui contiendra tout (pour mieux gérer le scroll si besoin)
        main_container = ctk.CTkFrame(self, fg_color="transparent")
        main_container.grid(row=0, column=0, sticky="nsew")
        main_container.grid_rowconfigure(5, weight=1)  # Le dernier élément prend le poids
        ...
        self.tables_frame = ctk.CTkFrame(main_container, fg_color="transparent")
        self.tables_frame.grid(row=3, column=0, sticky="nsew", padx=20, pady=10)
        
        # Configurer pour que tables_frame prenne l'espace restant
        ...
        refresh_button.grid(row=4, column=0, pady=(15, 10))
        ...
        self.update_label.grid(row=5, column=0, pady=(0, 15))
    ...
    def create_tables_section(self):
        ...
        # Configurer tables_frame pour utiliser grid
