...
class MainWindow(ctk.CTk):
    def __init__(self, admin_info=None):
        ...
        self.nav_frame = ctk.CTkFrame(
            ...
            height=70, 
            corner_radius=0,
            fg_color="#1a1a2e",  # Couleur foncée pour la navbar
            border_width=0
        )
        ...
        self.logo_label = ctk.CTkLabel(
            ...
            text="🏨 MyHotel PMS",
            font=("Arial", 22, "bold"),
            text_color="#e67e22"  # Orange pour le logo
        )
        ...
        for text, tab_name in nav_items:
            btn = ctk.CTkButton(
                ...
                height=40,
                corner_radius=20,
                fg_color="transparent",  # Fond transparent par défaut
                text_color="white",      # Texte blanc
                hover_color="#e67e22",   # Orange au survol
        ...
        # Afficher le nom de l'admin en bas à droite (optionnel)
        if self.admin_info:
    ...
    def set_active_button(self, tab_name):
        ...
        for name, btn in self.nav_buttons.items():
            if name == tab_name:
                btn.configure(
                    fg_color="#e67e22",  # Orange pour le bouton actif
                    text_color="white"
                )
            else:
                btn.configure(
