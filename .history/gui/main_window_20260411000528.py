...
class MainWindow(ctk.CTk):
    def __init__(self, admin_info=None):  # Ajout du paramètre manquant
        super().__init__()
        self.admin_info = admin_info
        self.title("Gestion d'Hôtel - MyHotel")
        ...
        # Afficher le nom de l'admin en bas à droite (seulement si admin_info existe)
        if self.admin_info:
