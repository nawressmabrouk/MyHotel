...
class HomeFrame(ctk.CTkFrame):
    ...
    def create_widgets(self):
        ...
        # === OVERLAY PRINCIPAL (dans le frame scrollable) ===
        ...
        subtitle = ctk.CTkLabel(
            header_frame,
            text="Solution complète pour la gestion de votre hôtel",
            font=("Arial", 14),
