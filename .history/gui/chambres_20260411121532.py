    ...
    def open_form(self, chambre_id=None):
        ...
        def save():
            ...
            try:
                ...
                messagebox.showerror("Erreur", "Le prix doit être un nombre positif (ex: 50.00).")
                entry_prix.focus()
                return
            ...
            if chambre_id:
                query = """UPDATE chambres 
                           ...
                           WHERE id=%s"""
                params = (numero, chambre_type, prix_float, statut, chambre_id)
            else:
                query = """INSERT INTO chambres (numero, type, prix_nuit, statut) 
                           VALUES (%s, %s, %s, %s)"""
                params = (numero, chambre_type, prix_float, statut)
