...
import csv
from gui.styles import configure_treeview_styles
...
class FacturesFrame(ctk.CTkFrame):
    ...
    def create_widgets(self):
        # === FRAME POUR LE TABLEAU (avec bordure et ombre) ===
        ...
        # === FRAME DES BOUTONS (arrondis et colorés) ===
        ...
        # === INFO BAR (nombre d'enregistrements) ===
    ...
    def load_data(self):
        ...
        if rows:
            for r in rows:
                # Alterner les couleurs des lignes (optionnel)
    ...
    def open_form(self, facture_id=None):
        # Formulaire d'ajout/modification (à implémenter avec le même style)
        pass
