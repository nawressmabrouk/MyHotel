...
class HomeFrame(ctk.CTkFrame):
    ...
    def create_widgets(self):
        ...
        # Séparateur
        separator = ctk.CTkFrame(content_frame, height=3, fg_color="#e67e22")
        ...
        desc2 = ctk.CTkLabel(
            desc_frame,
            text="Avec MyHotel PMS, centralisez vos réservations, gérez vos chambres en temps réel, suivez vos clients et automatisez la facturation. Notre interface claire et notre tableau de bord personnalisé vous permettent de prendre des décisions éclairées et d'augmenter votre rentabilité.",
            font=("Arial", 14),
            justify="center",
            wraplength=800,
            text_color=("gray30", "gray80")
        ...
        features_title = ctk.CTkLabel(
            content_frame,
            text="📋 Ce que vous pouvez faire avec MyHotel PMS",
            font=("Arial", 22, "bold"),
            text_color="#e67e22"
        )
        ...
        features = [
            {"icon": "🛏️", "title": "Gestion des chambres", "desc": "Ajoutez, modifiez ou supprimez des chambres. Suivez leur statut en temps réel.", "color": "#2ecc71", "tab": "Chambres"},
            {"icon": "👥", "title": "Gestion des clients", "desc": "Maintenez un carnet d'adresses complet de vos clients. Recherchez, modifiez ou supprimez des fiches clients.", "color": "#3498db", "tab": "Clients"},
            ...
            {"icon": "💰", "title": "Gestion des factures", "desc": "Générez automatiquement des factures basées sur la durée du séjour.", "color": "#e74c3c", "tab": "Factures"}
        ]
        ...
        footer = ctk.CTkLabel(
            footer_frame,
            text="© 2025 - MyHotel PMS - Solution professionnelle de gestion hôtelière",
            font=("Arial", 11),
            text_color="gray"
        )
        footer.pack(pady=5)
