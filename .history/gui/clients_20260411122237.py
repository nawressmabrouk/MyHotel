    ...
    def open_form(self, client_id=None):
        ...
        if client_id:
            row = db.execute_query(
                "SELECT nom, email, telephone, adresse FROM clients WHERE id = %s",
        ...
        def save():
            ...
            if "@" not in email or "." not in email:
                messagebox.showerror("Erreur", "Veuillez entrer un email valide (ex: nom@domaine.com).")
                entry_email.focus()
                return
            ...
            if client_id:
                query = """UPDATE clients 
                           ...
                           WHERE id=%s"""
                params = (nom, email, telephone if telephone else None, adresse if adresse else None, client_id)
            else:
                query = """INSERT INTO clients (nom, email, telephone, adresse) 
                           VALUES (%s, %s, %s, %s)"""
                params = (nom, email, telephone if telephone else None, adresse if adresse else None)
