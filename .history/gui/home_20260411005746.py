...
class HomeFrame(ctk.CTkFrame):
    ...
    def create_widgets(self):
        ...
        title = ctk.CTkLabel(
            ...
            text="🏨 MyHotel PMS",
            font=("Arial", 44, "bold"),
            text_color=("white", "#3a7eb6")  # Blanc pour mieux voir sur l'image
        )
        title.pack()
        ...
        subtitle = ctk.CTkLabel(
            ...
            font=("Arial", 18),
            text_color="white"  # Blanc pour mieux voir sur l'image
        )
        ...
        for i, feature in enumerate(features):
            ...
            card = ctk.CTkFrame(
                ...
                fg_color=("#ffffffcc", "#333333cc"),  # Semi-transparent
                cursor="hand2"
            )
        ...
        for i, (icon, title_b, desc_b) in enumerate(benefits):
            col = i
            benefit_card = ctk.CTkFrame(benefits_container, corner_radius=10, fg_color=("#ffffffcc", "#2b2b2bcc"))
