...
class HomeFrame(ctk.CTkFrame):
    ...
    def create_widgets(self):
        ...
        # === FRAME SCROLLABLE AVEC FOND TRANSPARENT ===
        ...
        for i, feature in enumerate(features):
            ...
            # Utiliser une couleur unie semi-transparente n'est pas supporté
            # On utilise une couleur unie avec un peu d'opacité visuelle
            card = ctk.CTkFrame(
                features_container, 
                corner_radius=15, 
                border_width=2,
                border_color=feature["color"],
                fg_color=("#f8f9fa", "#2b2b2b"),  # Couleurs unies sans transparence
                cursor="hand2"
            )
        ...
        benefits_title = ctk.CTkLabel(
            benefits_frame,
            text="⭐ Pourquoi choisir MyHotel PMS ?",
            font=("Arial", 22, "bold"),
            text_color="#e67e22"
        )
        ...
        for i, (icon, title_b, desc_b) in enumerate(benefits):
            col = i
            benefit_card = ctk.CTkFrame(benefits_container, corner_radius=10, fg_color=("#f8f9fa", "#2b2b2b"))
        ...
        footer_sep = ctk.CTkFrame(footer_frame, height=1, fg_color="white")
