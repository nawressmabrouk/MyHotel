...
class HomeFrame(ctk.CTkFrame):
    ...
    def create_widgets(self):
        ...
        # === OVERLAY GLASSMORPHISM (semi-transparent avec effet "flou") ===
        # Utilisation de fg_color avec transparence (fonctionne avec customtkinter)
        # Pour un vrai flou, on applique un filtre sur l'image de fond (optionnel)
        
        overlay_frame = ctk.CTkFrame(
            self, 
            fg_color=("#ffffffcc", "#2b2b2bcc"),  # cc = 80% d'opacité (environ)
            corner_radius=20,
            border_width=1,
            border_color=("#ffffffaa", "#3a3a3aaa")
        )
        ...
        for i, (title_text, desc, tab_name) in enumerate(features):
            ...
            card = ctk.CTkFrame(
                ...
                corner_radius=12, 
                border_width=1, 
                border_color=("#ccccccaa", "#555555aa"),
                fg_color=("#ffffffdd", "#3a3a3add")  # cartes semi-transparentes aussi
            )
